...
namespace Tests
{
    public class PlayerHand_Tests
    {
        ...
        public void SelectCard_Test()
        {
            ...
            Assert.AreEqual(false, hand.SelectCard(cardH11));
            Assert.AreEqual(selectedCards.Count, 2);
            Assert.AreEqual(selectedCards[0], cardS4);
